"""
Text-mode arrival-rate sweep — TEMPLATE.

Edit RATES if you need a different range. Keep the rest of the
structure: plot_sweep.py imports RATES from here so the visual sweep
